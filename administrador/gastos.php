  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
			<a href="histpagos.php?id=<?php echo $_GET['id'] ?>">Historial de pagos</a>
				...
				<form method="POST" action="sendGasto.php">
					...
					<div class="box-body">
						...
						<select class="form-control select2" style="width: 100%;" name="motivo">
								<option value="servicio_serivico">Pago de Servicios Sanitarios</option>
								<option value="pago_empleado">Pago Empleados</option>
								<option value="equipos">Compra de maquinaria</option>
						</select>
						</div>
						<div class="form-group">
				...
				$ddata=$con->query("SELECT * FROM gastos ORDER BY id desc");

				 ?>
				<br>
				<label>Historial de egresos</label>
				<table border="2" class="table table-hover dataTable" role="grid" aria-describedby="example2_info">
					...
					<tbody>
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td><strong>Bs. <?php echo $total; ?></strong></td>
						</tr>
					</tbody>
				</table>
    </section>
