...
<?php
	...
	$ddata=$con->query("SELECT * FROM pagos WHERE confirmacion = 'pendiente' ORDER BY id desc ");
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <section class="content container-fluid">
			<body>
				<table border="2" class="table table-hover dataTable" role="grid" aria-describedby="example2_info">
					<a href="all_pagos.php?id=<?php echo $_GET['id'] ?>">Historial de Pagos</a><br>
						<thead>
							<tr>
								<td>id</td>
								<td>Usuario</td>
						...
						<tbody>
							...
							<tr>
								...
								<th><a href="validar_pagos.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['id'] ?>"><li class="fa fa-bullhorn"></li>Validar</a></th>
							</tr>
							<?php } ?>
						</tbody>
					</table>
