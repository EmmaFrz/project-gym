			...
			<a href="nuevo_entrenador.php?id=<?php  echo $_GET['id'] ?>">Agregar Nuevo</a><br>
				...
				<tbody>
					...
					<tr>
						...
						<th><a href="eliminar_entrenador.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['id']; ?>"><li class="fa fa-close"></li>Eliminar</a><br><a href="modificar_entrenador.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['id']; ?>"><li class="fa fa-edit"></li>Editar</a></th>
					</tr>
					<?php } ?>
				</tbody>
			</table>
