<?php
	...
	$datos=$con->query("SELECT * FROM entrenador WHERE id = '{$_GET['id']}'");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
			<form role="form" action="modi_entrenador.php" method="POSt">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<label>Nombre</label>
							<input type="text" class="form-control" name="nombre"  pattern="[A-Z a-z]+" placeholder="Ingrese nombre" required value="<?php echo $data['nombre']; ?>">
						</div>
						<div class="form-group">
							<label>Direccion</label>
							<input type="text" class="form-control" name="dir" placeholder="Ingrese Direccion" required value="<?php  echo $data['direccion']; ?>">
						</div>
						<div class="form-group">
							<label>Email</label>
