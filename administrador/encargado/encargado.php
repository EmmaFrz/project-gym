...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
			<a href="nuevo_encargado.php?id=<?php echo $_GET['id'] ?>">Agregar Nuevo</a>
			<table border="2" class="table table-hover dataTable" role="grid" aria-describedby="example2_info">
				...
				<tbody>
					...
					<tr>
						...
						<th><?php echo $row['id_permiso']; ?></th>
						<th><a href="eliminar_encargado.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['id'] ?>"><li class="fa fa-close"></li>Eliminar</aBorrar</a> --- <a href="modificar_encargado.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['id'] ?>"><li class="fa fa-edit"></li>Editar</a></th>
					</tr>
					<?php } ?>
				</tbody>
			</table>
