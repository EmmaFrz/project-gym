				...
				<table border="2" class="table table-hover dataTable" role="grid" aria-describedby="example2_info">
					...
					<tbody>
						...
						<tr>
							...
							<th><a href="eliminar_plan.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['id'] ?>"><li class="fa fa-close"></li>Eliminar</aBorrar</a> --- <a href="modificar_plan.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['id'] ?>"><li class="fa fa-edit"></li>Editar</a></th>
						</tr>
						<?php } ?>
					</tbody>
				</table>
