	<?php	require_once("../conexion.php");
		...
		$date = (isset($fecha)) ? da(new DateTime($fecha)) : date('d-m-Y');

		$ddata=$con->query("SELECT * FROM caja WHERE fecha = '$date' ORDER BY id desc");
	...
	<div class="wrapper">
	  ...
	  <header class="main-header">
	    <!-- Logo -->
			<a href="emcargado_index.php?id=<?php echo $_GET['id'] ?>" class="logo">
	    ...
	    <section class="content container-fluid">
					...
					<tbody>
						...
						<tr>
							...
							<th><?php
							$data=$con->query("SELECT * FROM administrador WHERE id = $row[id_caja]");
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td><strong>TOTAL:</strong>Bs. <?php echo $total; ?></td>
						</tr>
					</tbody>
				</table>
	    </section>
