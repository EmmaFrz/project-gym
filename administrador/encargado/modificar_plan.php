<?php
	...
	$datos=$con->query("SELECT * FROM plan WHERE id = '{$_GET['id']}'");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
			<form action="modi_plan.php" method="POST">
				...
				<input type="hidden" name="id" value="<?php echo $data['id']; ?>">
					<div class="box-body">
						...
						<div class="form-group">
							<label>Precio</label>
							<input type="number" class="form-control" name="precio" value="<?php  echo $data['precio']; ?>" required>
						</div>
							<label>Descripcion</label>
							<input type="text" class="form-control" required  name="des" value="<?php echo $data['descripcion']; ?>">
						<div class="form-group">
							<label>Turno</label>
