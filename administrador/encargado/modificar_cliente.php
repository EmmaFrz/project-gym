...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
			<form role="form" action="modi_clientes.php" method="POST">
				<input type="hidden" name="id2" value="<?php echo $_GET['id2'] ?>">
				<input type="hidden" name="id" value="<?php echo $data['id']; ?>">
					<div class="box-body">
						<div class="form-group">
							<label>Nombre</label>
							<input type="text"  pattern="[A-Z a-z]+" class="form-control" name="nombre" placeholder="Ingrese nombre" required value="<?php echo $data['nombre'] ?>">
						</div>
						<div class="form-group">
							<label>Cedula</label>
							<input type="number" class="form-control" name="ci" placeholder="Ingrese Cedula" required value="<?php  echo $data['ci']; ?>">
						</div>
						<div class="form-group">
							<label>Direccion</label>
							<input type="text" class="form-control" name="direccion" placeholder="Ingrese Direccion" required  value="<?php  echo $data['direccion']; ?>">
						</div>
						<div class="form-group">
							<label>Email</label>
							<input type="email" class="form-control" name="email" placeholder="Ingrese Correo" required value="<?php  echo $data['correo']; ?>">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" name="tel" placeholder="Ingrese Telefono" required value="<?php  echo $data['telefono']; ?>">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>Peso(Kg)</label>
							<input type="number" class="form-control" name="peso" required value="<?php  echo $data['peso']; ?>">
						</div>
						<div class="form-group">
							<label>Estatura(Cm)</label>
							<input type="number" class="form-control" name="estatura" required value="<?php  echo $data['estatura']; ?>">
						</div>
					</div>
					<!-- /.box-body -->
