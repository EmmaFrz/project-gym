<?php
	...
	$data=$con->query("SELECT * FROM entrenador ORDER BY id desc");
?>
<!DOCTYPE html>
<html>
<head>
			...
			<a href="nuevo_entrenador.php?id=<?php  echo $_GET['id'] ?>">Agregar Nuevo</a><br>
				...
				<tbody>
					...
					<tr>
						...
						<th><?php echo $row['tipo_entrenador']; ?></th>
						<th><?php echo $row['telefono']; ?></th>
						<th><?php echo $row['ci']; ?></th>
						<th><?php echo $row['correo']; ?></th>
						<th>
							<?php echo $row['id_plan']; ?>
						</th>
						<th><?php if ($row['tipo_entrenador']=='personal') {
								echo "25.000";
						} else {
								echo "30.000";
						}?>
					</th>
						<th><a href="eliminar_entrenador.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['id']; ?>"><li class="fa fa-close"></li>Eliminar</aBorrar</a> --- <a href="modificar_entrenador.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['id']; ?>"><li class="fa fa-edit"></li>Editar</a></th>
					</tr>
					<?php } ?>
				</tbody>
			</table>
